...
setDeals(allDeals.filter(deal => deal.contact_id_c === contactData.Id || deal.contact_id_c?.Id === contactData.Id));
      setActivities(allActivities.filter(activity => activity.contact_id_c === contactData.Id || activity.contact_id_c?.Id === contactData.Id));
    } catch (err) {
...
{deals.filter(deal => deal.stage_c !== "Closed").map(deal => (
                        <DealCard
                          key={deal.Id}
                          deal={deal}
                          contact={contact}
